                    ...
                    <div class="card-body p-md-5">
                      <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                          ...
                          <form class="mx-1 mx-md-4" action="<?php echo e(route('authenticate')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH F:\02-BELAJAR\02.LARAVEL\laravel_toko\resources\views/login/index.blade.php ENDPATH**/ ?>